...
Dropki operator + (int a, const Dropki &b) {
    return Dropki(a * b.delitel + b.delenik, b.delitel);
}

Dropki operator + (const Dropki &b, int a) {
    return Dropki(a * b.delitel + b.delenik, b.delitel);
}
...
Dropki operator * (int a, const Dropki &b) {
    return Dropki(a * b.delenik, b.delitel);
}
...
Dropki operator / (int a, const Dropki &b) {
    return Dropki(a * b.delitel, b.delenik);
}
...
std::ostream& operator << (std::ostream &in, const Dropki &d) {
    if(d.delitel == 1)
        ...
        in << d.delenik << "/" << d.delitel << endl;
        in << "Realen format: " << (double)d.delenik / d.delitel;
    }
    return in;
}
